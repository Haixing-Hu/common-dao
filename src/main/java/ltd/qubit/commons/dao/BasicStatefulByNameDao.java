...
import ltd.qubit.commons.dao.mapper.BasicStatefulByNameMapper;
 ...
 * @author 胡海星
 */
public interface BasicStatefulByNameDao<T extends Identifiable & WithName & Stateful & Auditable>
    extends BasicByNameDao<T>, StateUpdatableDao<T>, StateUpdatableByNameDao<T> {

  @Override
  BasicStatefulByNameMapper<T> getMapper();
