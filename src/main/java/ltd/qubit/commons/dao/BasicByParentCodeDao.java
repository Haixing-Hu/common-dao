...
import ltd.qubit.commons.dao.mapper.BasicByParentCodeMapper;
 ...
 * @author 胡海星
 */
public interface BasicByParentCodeDao<T extends Identifiable & WithCode & Deletable>
    extends BasicDao<T>, ListableAddOrUpdatableByParentCodeDao<T>,
    DeletableByParentCodeDao<T>, ErasableByParentCodeDao<T> {

  @Override
  BasicByParentCodeMapper<T> getMapper();
