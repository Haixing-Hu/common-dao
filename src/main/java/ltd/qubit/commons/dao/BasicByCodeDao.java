...
import ltd.qubit.commons.dao.mapper.BasicByCodeMapper;
 ...
 * @author 胡海星
 */
public interface BasicByCodeDao<T extends Identifiable & WithCode & Deletable>
    extends BasicDao<T>, ListableAddOrUpdatableByCodeDao<T>,
    DeletableByCodeDao<T>, ErasableByCodeDao<T> {

  @Override
  BasicByCodeMapper<T> getMapper();
