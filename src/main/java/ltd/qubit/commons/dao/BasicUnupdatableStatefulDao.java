...
import ltd.qubit.commons.dao.mapper.BasicUnupdatableStatefulMapper;
 ...
 * @author 胡海星
 */
public interface BasicUnupdatableStatefulDao
      <T extends Identifiable & Stateful & Creatable & Deletable>
    extends BasicUnupdatableDao<T>, StateUpdatableDao<T> {

  @Override
  BasicUnupdatableStatefulMapper<T> getMapper();
