...
import ltd.qubit.commons.dao.mapper.ListableAddOrUpdatableByParentCodeMapper;
 ...
 * @author 胡海星
 */
public interface ListableAddOrUpdatableByParentCodeDao<T extends WithCode>
    extends ListableDao<T>, AddOrUpdatableByParentCodeDao<T> {

  @Override
  ListableAddOrUpdatableByParentCodeMapper<T> getMapper();
}
