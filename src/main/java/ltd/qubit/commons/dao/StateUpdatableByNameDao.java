...
import ltd.qubit.commons.dao.mapper.StateUpdatableByNameMapper;
 ...
 * @author 胡海星
 */
public interface StateUpdatableByNameDao<T extends WithName & Stateful>
    extends Dao<T> {

  @Override
  StateUpdatableByNameMapper<T> getMapper();
  ...
  default Instant updateStateByName(final String name, final State state)
      throws DataAccessException {
    return updatePropertyByKeyImpl(this,
        modifyTime -> getMapper().updateStateByName(name, state, modifyTime),
