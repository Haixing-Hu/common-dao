...
import ltd.qubit.commons.dao.mapper.BasicHasInfoWithEntityMapper;
 ...
 * @author 胡海星
 */
public interface BasicHasInfoWithEntityDao<T extends HasInfoWithEntity & Auditable>
    extends BasicDao<T>, InfoWithEntityGettableDao<T> {

  @Override
  BasicHasInfoWithEntityMapper<T> getMapper();
