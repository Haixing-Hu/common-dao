 ...
 * @author 胡海星
 */
public interface VisibilityUpdatableDao<T extends Identifiable & WithVisibility>
    extends Dao<T> {

  @Override
  VisibilityUpdatableMapper<T> getMapper();
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  @Modified({"visible", "modifyTime"})
  default Instant updateVisible(final Long id, final Boolean visible)
      throws DataAccessException {
    return updatePropertyByKeyImpl(this,
        modifyTime -> getMapper().updateVisible(id, visible, modifyTime),
