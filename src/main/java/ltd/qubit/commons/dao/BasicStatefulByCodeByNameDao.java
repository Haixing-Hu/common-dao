...
import ltd.qubit.commons.dao.mapper.BasicStatefulByCodeByNameMapper;
 ...
 * <li>{@link #updateStateByName(String, State)}</li>
 ...
 * @author 胡海星
 */
public interface BasicStatefulByCodeByNameDao
    <T extends Identifiable & WithName & WithCode & Stateful & Auditable>
    extends BasicStatefulByCodeDao<T>, ListableAddOrUpdatableByNameDao<T>,
    StateUpdatableByNameDao<T>, DeletableByNameDao<T>, ErasableByNameDao<T> {

  @Override
  BasicStatefulByCodeByNameMapper<T> getMapper();
