...
import ltd.qubit.commons.dao.mapper.BasicStatefulByParentCodeMapper;
 ...
 * 彻底删除、清空数据库等操作的DAO。
 *
 * <p><b>注意：</b>对象的编码在其所属Parent下必须唯一。</p>
 *
 * <p>此接口实现了以下DAO操作：</p>
 * <ul>
 ...
 * @author 胡海星
 */
public interface BasicStatefulByParentCodeDao
    <T extends Identifiable & WithCode & Stateful & Auditable>
    extends BasicByParentCodeDao<T>, StateUpdatableDao<T>, StateUpdatableByParentCodeDao<T> {

  @Override
  BasicStatefulByParentCodeMapper<T> getMapper();
