 ...
 * <p>此接口实现了以下DAO操作：</p>
 * <ul>
 * <li>{@link #updateOrganizationByCode(String, StatefulInfo)}</li>
 * </ul>
 *
 * @param <T>
 ...
 * @author 胡海星
 */
public interface OrganizationUpdatableByCodeDao<T extends WithCode & WithOrganization>
    extends Dao<T> {

  @Override
  OrganizationUpdatableByCodeMapper<T> getMapper();
  ...
  default Instant updateOrganizationByCode(final String code,
      final StatefulInfo organization) throws DataAccessException {
    return updatePropertyByKeyImpl(this,
        modifyTime -> getMapper().updateOrganizationByCode(code, organization, modifyTime),
