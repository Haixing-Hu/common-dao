...
import ltd.qubit.commons.dao.mapper.ErasableByParentNameMapper;
 ...
 * @author 胡海星
 */
public interface ErasableByParentNameDao<T extends WithName>
    extends Dao<T> {

  @Override
  ErasableByParentNameMapper<T> getMapper();
   ...
   */
  default void eraseByName(final Long parentId, final String name)
      throws DataAccessException {
    DaoImplHelper.eraseByKeyImpl(this, t -> getMapper().eraseByName(parentId, name),
