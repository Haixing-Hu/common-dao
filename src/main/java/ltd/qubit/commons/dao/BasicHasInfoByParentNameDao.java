...
import ltd.qubit.commons.dao.mapper.BasicHasInfoByParentNameMapper;
 ...
 * @author 胡海星
 */
public interface BasicHasInfoByParentNameDao<T extends HasInfo & Auditable>
    extends BasicByParentNameDao<T>, InfoGettableDao<T>, InfoGettableByParentNameDao<T> {

  @Override
  BasicHasInfoByParentNameMapper<T> getMapper();
