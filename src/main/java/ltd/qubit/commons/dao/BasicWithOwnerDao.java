 ...
 * @author 胡海星
 */
public interface BasicWithOwnerDao<T extends Identifiable & WithOwner & Auditable>
    extends BasicDao<T>, GettableForOwnerDao<T>, DeletableForOwnerDao<T>,
    ErasableByOwnerDao<T> {

  @Override
  BasicWithOwnerMapper<T> getMapper();
