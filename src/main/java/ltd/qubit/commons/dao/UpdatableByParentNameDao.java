...
import ltd.qubit.commons.dao.mapper.UpdatableByParentNameMapper;
 ...
 * @author 胡海星
 */
public interface UpdatableByParentNameDao<T extends WithName>
    extends Dao<T> {

  @Override
  UpdatableByParentNameMapper<T> getMapper();

  /**
   * 根据名称更新一个已存在的实体。
   *
   * @param obj
   *     待更新的已存在的实体对象的新数据，更新时使用其<b>所属父对象的ID</b>及其<b>名称</b>
   *     确定该对象。
   * @return
   *     数据被修改时的时间戳。
