...
import ltd.qubit.commons.dao.mapper.BasicByCodeByParentNameMapper;
 ...
 * @author 胡海星
 */
public interface BasicByCodeByParentNameDao
    <T extends Identifiable & WithCode & WithName & Auditable>
    extends BasicByCodeDao<T>,
    GettableByParentNameDao<T>, UpdatableByParentNameDao<T>,
    AddOrUpdatableByParentNameDao<T>, DeletableByParentNameDao<T>,
    ErasableByParentNameDao<T> {

  @Override
  BasicByCodeByParentNameMapper<T> getMapper();
