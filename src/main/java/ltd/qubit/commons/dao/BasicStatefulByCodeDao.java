...
import ltd.qubit.commons.dao.mapper.BasicStatefulByCodeMapper;
 ...
 * @author 胡海星
 */
public interface BasicStatefulByCodeDao<T extends Identifiable & WithCode & Stateful & Auditable>
    extends BasicByCodeDao<T>, StateUpdatableDao<T>, StateUpdatableByCodeDao<T> {

  @Override
  BasicStatefulByCodeMapper<T> getMapper();
