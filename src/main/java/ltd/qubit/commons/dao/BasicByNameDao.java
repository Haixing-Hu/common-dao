...
import ltd.qubit.commons.dao.mapper.BasicByNameMapper;
 ...
 * @author 胡海星
 */
public interface BasicByNameDao<T extends Identifiable & WithName & Deletable>
    extends BasicDao<T>, ListableAddOrUpdatableByNameDao<T>,
    DeletableByNameDao<T>, ErasableByNameDao<T> {

  @Override
  BasicByNameMapper<T> getMapper();
