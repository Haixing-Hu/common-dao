...
import ltd.qubit.commons.dao.mapper.AddOrUpdatableByEntityNameMapper;
...
import static ltd.qubit.commons.dao.DaoImplHelper.addOrUpdateByEntityNameImpl;
 ...
 * @author 胡海星
 */
public interface AddOrUpdatableByEntityNameDao
    <T extends Identifiable & WithEntity & WithName>
    extends GettableByEntityNameDao<T>, AddableDao<T>, UpdatableByEntityNameDao<T> {

  @Override
  AddOrUpdatableByEntityNameMapper<T> getMapper();
   ...
   *     若发生任何其他数据存取错误。
   */
  default Instant addOrUpdateByName(final T obj) throws DataAccessException {
    return addOrUpdateByEntityNameImpl(this, obj);
  }
