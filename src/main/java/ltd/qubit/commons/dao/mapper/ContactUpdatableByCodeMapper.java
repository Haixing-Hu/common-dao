...
/**
 * 此接口表示对有联系方式的实体类实现了更新联系方式操作的MyBatis Mapper。
 *
 * <p><b>注意：</b>对象的编码必须全局唯一。</p>
 *
 * <p>此接口实现了以下Mapper操作：</p>
 * <ul>
 * <li>{@link #updateContactByCode(String, Contact, Instant)}</li>
 * </ul>
 *
 * @param <T>
 ...
 * @author 胡海星
 */
public interface ContactUpdatableByCodeMapper
    <T extends WithCode & WithContact> extends Mapper<T> {
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateContactByCode(@Param("code") String code,
      @Nullable @Param("contact") Contact contact,
