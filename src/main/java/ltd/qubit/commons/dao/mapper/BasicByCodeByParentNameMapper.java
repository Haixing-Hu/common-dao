 ...
 * 等操作的MyBatis Mapper。
 *
 * <p><b>注意：</b>对象的编码必须全局唯一，名称在其所属父对象下也必须唯一。</p>
 *
 ...
 * @author 胡海星
 */
public interface BasicByCodeByParentNameMapper
    <T extends Identifiable & WithCode & WithName & Auditable>
    extends BasicByCodeMapper<T>, GettableByParentNameMapper<T>,
    UpdatableByParentNameMapper<T>, AddOrUpdatableByParentNameMapper<T>,
