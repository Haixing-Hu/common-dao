...
/**
 * 此接口表示对拥有{@code info}属性和全局唯一编码的实体类实现了查询操作的MyBatis Mapper。
 *
 ...
 * @author 胡海星
 */
public interface InfoGettableByCodeMapper<T extends HasInfo> extends Mapper<T> {
   ...
   */
  @Nullable
  Info getInfoByCode(@Param("code") String code) throws DataAccessException;
