 ...
 * <ul>
 * <li>{@link #updateSecurityKey(Long, String, Instant)}</li>
 * </ul>
 *
 * @param <T>
 ...
 * @author 胡海星
 */
public interface SecurityKeyUpdatableMapper<T extends Identifiable & WithSecurityKey>
    extends Mapper<T> {
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateSecurityKey(@Param("id") Long id,
