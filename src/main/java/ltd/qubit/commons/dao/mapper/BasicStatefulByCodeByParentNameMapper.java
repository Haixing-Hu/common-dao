 ...
 * <li>{@link #updateStateByName(Long, String, State, Instant)}</li>
 ...
 * @author 胡海星
 */
public interface BasicStatefulByCodeByParentNameMapper
    <T extends Identifiable & WithName & WithCode & Stateful & Auditable>
    extends BasicStatefulByCodeMapper<T>,
    ListableAddOrUpdatableByParentNameMapper<T>,
    StateUpdatableByParentNameMapper<T>,
    DeletableByParentNameMapper<T>,
    ErasableByParentNameMapper<T> {
  // empty
}
