 ...
 * @author 胡海星
 */
public interface BasicByNameMapper<T extends Identifiable & WithName & Deletable>
    extends BasicMapper<T>, ListableAddOrUpdatableByNameMapper<T>,
    DeletableByNameMapper<T>, ErasableByNameMapper<T> {
  //  empty
}
