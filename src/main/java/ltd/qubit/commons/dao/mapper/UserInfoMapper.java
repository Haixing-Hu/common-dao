...
/**
 * 此接口表示实现了对{@link UserInfo}类进行查询、添加、更新、删除等基本操作的
 * MyBatis Mapper。
 *
 ...
 * @author 胡海星
 */
public interface UserInfoMapper extends GettableMapper<UserInfo>,
    GettableByUsernameMapper<UserInfo>, AddableMapper<UserInfo>,
    UpdatableMapper<UserInfo>, DeletableMapper<UserInfo>,
    ErasableMapper<UserInfo>, ClearableMapper<UserInfo> {
  //  empty
}
