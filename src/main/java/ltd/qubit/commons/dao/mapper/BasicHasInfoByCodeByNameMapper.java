 ...
 * @author 胡海星
 */
public interface BasicHasInfoByCodeByNameMapper<T extends HasInfo & Auditable>
    extends BasicByCodeByNameMapper<T>, InfoGettableMapper<T>,
    InfoGettableByCodeMapper<T>, InfoGettableByNameMapper<T> {
  // empty
}
