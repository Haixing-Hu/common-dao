 ...
 * @author 胡海星
 */
public interface StatefulInfoGettableByCodeMapper<T extends HasStatefulInfo>
   ...
   */
  @Nullable
  StatefulInfo getInfoByCode(@Param("code") String code) throws DataAccessException;
