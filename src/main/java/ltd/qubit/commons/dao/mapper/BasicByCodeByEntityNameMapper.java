 ...
 * 等操作的MyBatis Mapper。
 *
 * <p><b>注意：</b>对象的编码必须全局唯一，名称也必须全局唯一。</p>
 *
 ...
 * @author 胡海星
 */
public interface BasicByCodeByEntityNameMapper
    <T extends Identifiable & WithCode & WithEntity & WithName & Auditable>
    extends BasicByCodeMapper<T>, GettableByEntityNameMapper<T>,
    UpdatableByEntityNameMapper<T>, AddOrUpdatableByEntityNameMapper<T>,
    DeletableByEntityNameMapper<T>, ErasableByEntityNameMapper<T> {
  //  empty
}
