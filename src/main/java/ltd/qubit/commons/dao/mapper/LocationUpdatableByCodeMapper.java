...
/**
 * 此接口表示对有地理位置坐标的实体类实现了更新地理位置坐标操作的MyBatis Mapper。
 *
 * <p><b>注意：</b>对象的编码必须全局唯一。</p>
 *
 * <p>此接口实现了以下Mapper操作：</p>
 * <ul>
 * <li>{@link #updateLocationByCode(String, Location, Instant)}</li>
 * </ul>
 *
 * @param <T>
 ...
 * @author 胡海星
 */
public interface LocationUpdatableByCodeMapper<T extends WithCode & WithLocation>
    extends Mapper<T> {
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateLocationByCode(@Param("code") String code,
      @Nullable @Param("location") Location location,
