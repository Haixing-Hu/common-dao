...
/**
 * 此接口表示对有令牌和全局唯一编码的实体类实现了更新令牌操作的MyBatis Mapper。
 *
 * <p><b>注意：</b>对象的编码必须全局唯一。</p>
 *
 * <p>此接口实现了以下Mapper操作：</p>
 * <ul>
 * <li>{@link #updateTokenByCode(String, Token, Instant)}</li>
 * </ul>
 *
 * @param <T>
 ...
 * @author 胡海星
 */
public interface TokenUpdatableByCodeMapper<T extends WithCode & WithToken>
    extends Mapper<T> {
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateTokenByCode(@Param("code") String code,
