 ...
 * @author 胡海星
 */
public interface BasicStatefulByNameMapper<T extends Identifiable & WithName & Stateful & Auditable>
    extends BasicByNameMapper<T>, StateUpdatableMapper<T>, StateUpdatableByNameMapper<T> {
  // empty
}
