 ...
 * @author 胡海星
 */
public interface BasicStatefulByCodeMapper<T extends Identifiable & WithCode & Stateful & Auditable>
    extends BasicByCodeMapper<T>, StateUpdatableMapper<T>, StateUpdatableByCodeMapper<T> {
  // empty
}
