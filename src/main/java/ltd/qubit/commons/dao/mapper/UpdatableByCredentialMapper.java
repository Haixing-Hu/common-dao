...
/**
 * 此接口表示实现根据证件更新实体操作的MyBatis Mapper。
 *
 ...
 * @author 胡海星
 */
public interface UpdatableByCredentialMapper<T extends Identifiable & WithCredential>
    extends GettableByCredentialMapper<T>, UpdatableMapper<T> {
  //  empty
}
