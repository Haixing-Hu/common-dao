 ...
 * <li>{@link #getInfoByCode(String, String)}，返回一个{@link StatefulInfo}对象</li>
 ...
 * @author 胡海星
 */
public interface BasicHasStatefulInfoByParentCodeMapper
    <T extends HasStatefulInfo & Auditable>
    extends BasicStatefulByParentCodeMapper<T>,
    StatefulInfoGettableMapper<T>,
    StatefulInfoGettableByParentCodeMapper<T> {
  // empty
}
