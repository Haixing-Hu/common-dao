...
/**
 * 此接口表示对有手机号码的实体类实现了更新手机号码操作的MyBatis Mapper。
 *
 ...
 * @author 胡海星
 */
public interface MobileUpdatableMapper<T extends Identifiable & WithMobile>
    extends Mapper<T> {
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateMobile(@Param("id") Long id, @Param("mobile") Phone mobile,
