...
/**
 * 此接口表示实现根据其所属父对象ID及其名称更新实体操作的MyBatis Mapper。
 *
 ...
 * @author 胡海星
 */
public interface UpdatableByParentNameMapper<T extends WithName>
    extends Mapper<T> {
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateByName(T entity) throws DataAccessException;
}
