 ...
 * <ul>
 * <li>{@link #updateLocation(Long, Location, Instant)}</li>
 * </ul>
 *
 * @param <T>
 ...
 * @author 胡海星
 */
public interface LocationUpdatableMapper<T extends Identifiable & WithLocation>
    extends Mapper<T> {
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateLocation(@Param("id") Long id,
