...
/**
 * 此接口表示对有安全密钥的实体类实现了更新安全密钥操作的MyBatis Mapper。
 *
 * <p><b>注意：</b>对象的编码必须全局唯一。</p>
 *
 * <p>此接口实现了以下Mapper操作：</p>
 * <ul>
 * <li>{@link #updateSecurityKeyByCode(String, String, Instant)}</li>
 * </ul>
 *
 * @param <T>
 ...
 * @author 胡海星
 */
public interface SecurityKeyUpdatableByCodeMapper
    <T extends WithCode & WithSecurityKey> extends Mapper<T> {
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateSecurityKeyByCode(@Param("code") String code,
