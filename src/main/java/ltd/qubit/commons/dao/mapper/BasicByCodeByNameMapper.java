 ...
 * @author 胡海星
 */
public interface BasicByCodeByNameMapper
    <T extends Identifiable & WithCode & WithName & Auditable>
    extends BasicByCodeMapper<T>, GettableByNameMapper<T>, UpdatableByNameMapper<T>,
    AddOrUpdatableByNameMapper<T>, DeletableByNameMapper<T>,
    ErasableByNameMapper<T> {
  //  empty
}
