 ...
 * @author 胡海星
 */
public interface InfoWithEntityGettableMapper<T extends HasInfoWithEntity>
    extends InfoGettableMapper<T> {
   ...
   */
  @Nullable
  InfoWithEntity getInfo(@Param("id") Long id) throws DataAccessException;
}
