...
/**
 * 此接口表示对拥有带状态的{@code info}属性和全局唯一令牌的值的实体类实现了查询操作的
 * MyBatis Mapper。
 *
 ...
 * @author 胡海星
 */
public interface StatefulInfoGettableByTokenMapper<T extends HasStatefulInfo & WithToken>
    extends InfoGettableByTokenMapper<T> {
   ...
   */
  @Nullable
  StatefulInfo getInfoByToken(@Param("token") Token token) throws DataAccessException;
