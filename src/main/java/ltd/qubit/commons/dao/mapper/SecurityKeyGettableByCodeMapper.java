...
/**
 * 此接口表示对拥有安全密钥属性的实体类实现了查询操作的MyBatis Mapper。
 *
 ...
 * @author 胡海星
 */
public interface SecurityKeyGettableByCodeMapper<T extends WithCode & WithSecurityKey>
    extends Mapper<T> {
   ...
   */
  @Nullable
  String getSecurityKeyByCode(@Param("code") String code) throws DataAccessException;
