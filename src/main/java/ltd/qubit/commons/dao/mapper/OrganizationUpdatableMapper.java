 ...
 * <ul>
 * <li>{@link #updateOrganization(Long, StatefulInfo, Instant)}</li>
 * </ul>
 *
 * @param <T>
 ...
 * @author 胡海星
 */
public interface OrganizationUpdatableMapper<T extends Identifiable & WithOrganization>
    extends Mapper<T> {
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateOrganization(@Param("id") Long id,
