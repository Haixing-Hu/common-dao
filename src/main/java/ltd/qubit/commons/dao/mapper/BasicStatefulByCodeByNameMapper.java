 ...
 * @author 胡海星
 */
public interface BasicStatefulByCodeByNameMapper
    <T extends Identifiable & WithName & WithCode & Stateful & Auditable>
    extends BasicStatefulByCodeMapper<T>, ListableAddOrUpdatableByNameMapper<T>,
    StateUpdatableByNameMapper<T>, DeletableByNameMapper<T>, ErasableByNameMapper<T> {
  // empty
}
