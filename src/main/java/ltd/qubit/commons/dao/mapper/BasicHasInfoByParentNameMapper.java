 ...
 * @author 胡海星
 */
public interface BasicHasInfoByParentNameMapper<T extends HasInfo & Auditable>
    extends BasicByParentNameMapper<T>, InfoGettableMapper<T>, InfoGettableByParentNameMapper<T> {
  // empty
}
