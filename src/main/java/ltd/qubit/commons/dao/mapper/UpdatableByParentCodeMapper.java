...
/**
 * 此接口表示实现根据所属App的ID及其编码更新实体操作的MyBatis Mapper。
 *
 ...
 * @author 胡海星
 */
public interface UpdatableByParentCodeMapper<T extends WithCode> extends Mapper<T> {

  /**
   * 根据所属App及其编码更新一个已存在的实体。
   *
   * @param obj
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateByCode(T obj) throws DataAccessException;
}
