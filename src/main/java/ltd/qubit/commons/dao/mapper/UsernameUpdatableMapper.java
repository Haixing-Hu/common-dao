...
/**
 * 此接口表示对有用户名的实体类实现了更新用户名操作的MyBatis Mapper。
 *
 * <p>此接口实现了以下Mapper操作：</p>
 * <ul>
 * <li>{@link #updateUsername(Long, String, Instant)}</li>
 * </ul>
 *
 * @param <T>
 ...
 * @author 胡海星
 */
public interface UsernameUpdatableMapper<T extends Identifiable & WithUsername>
    extends Mapper<T> {
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateUsername(@Param("id") Long id,
