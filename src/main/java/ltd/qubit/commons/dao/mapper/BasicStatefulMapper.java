...
/**
 * 此接口表示实现了对实体类进行列表、查询、添加、更新、更新状态、标记删除、恢复删除、彻底删除、
 * 清空数据库等操作的MyBatis Mapper。
 *
 ...
 * @author 胡海星
 */
public interface BasicStatefulMapper<T extends Identifiable & Stateful & Auditable>
    extends BasicMapper<T>, StateUpdatableMapper<T> {
