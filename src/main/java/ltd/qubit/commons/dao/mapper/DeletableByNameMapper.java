 ...
 * @author 胡海星
 */
public interface DeletableByNameMapper<T extends Identifiable & WithName & Deletable>
    extends Mapper<T> {
   ...
   * @throws DataAccessException
   *     若发生任何其他数据存取错误。
   * @see #deleteByName(String, Instant)
   * @see #purgeByName(String)
   */
  long restoreByName(@Param("name") String name) throws DataAccessException;
   ...
   * @see #restoreByName(String)
   */
  long purgeByName(@Param("name") String name) throws DataAccessException;
}
