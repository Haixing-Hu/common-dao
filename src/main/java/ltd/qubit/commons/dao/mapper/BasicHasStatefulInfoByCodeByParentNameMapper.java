 ...
 * <li>{@link #getInfoByName(String, String)}，返回一个{@link StatefulInfo}对象</li>
 ...
 * @author 胡海星
 */
public interface BasicHasStatefulInfoByCodeByParentNameMapper
    <T extends HasStatefulInfo & Auditable>
    extends BasicStatefulByCodeByParentNameMapper<T>,
    StatefulInfoGettableMapper<T>,
    StatefulInfoGettableByCodeMapper<T>,
    StatefulInfoGettableByParentNameMapper<T> {
  // empty
}
