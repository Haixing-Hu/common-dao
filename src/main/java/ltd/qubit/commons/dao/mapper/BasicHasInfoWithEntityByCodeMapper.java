 ...
 * @author 胡海星
 */
public interface BasicHasInfoWithEntityByCodeMapper<T extends HasInfoWithEntity & Auditable>
    extends BasicHasInfoWithEntityMapper<T>, GettableByCodeMapper<T>,
    InfoWithEntityGettableByCodeMapper<T>, UpdatableByCodeMapper<T>,
    AddOrUpdatableByCodeMapper<T>, DeletableByCodeMapper<T>,
    ErasableByCodeMapper<T> {
  // empty
}
