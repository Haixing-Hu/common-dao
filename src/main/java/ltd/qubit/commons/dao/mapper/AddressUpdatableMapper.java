...
/**
 * 此接口表示对有地址的实体类实现了更新地址操作的MyBatis Mapper。
 *
 * <p>此接口实现了以下Mapper操作：</p>
 * <ul>
 * <li>{@link #updateAddress(Long, Address, Instant)}</li>
 * </ul>
 *
 * @param <T>
 ...
 * @author 胡海星
 */
public interface AddressUpdatableMapper<T extends Identifiable & WithAddress>
    extends Mapper<T> {
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateAddress(@Param("id") Long id,
