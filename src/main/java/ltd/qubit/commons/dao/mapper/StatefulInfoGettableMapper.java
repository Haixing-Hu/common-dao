...
/**
 * 此接口表示对拥有带{@code state}和{@code info}属性的实体类实现了查询操作
 * 的MyBatis Mapper。
 *
 ...
 * @author 胡海星
 */
public interface StatefulInfoGettableMapper<T extends HasStatefulInfo>
   ...
   */
  @Nullable
  StatefulInfo getInfo(@Param("id") Long id) throws DataAccessException;
