 ...
 * @author 胡海星
 */
public interface BasicByParentCodeMapper
    <T extends Identifiable & WithCode & Deletable>
    extends BasicMapper<T>, ListableAddOrUpdatableByParentCodeMapper<T>,
    DeletableByParentCodeMapper<T>, ErasableByParentCodeMapper<T> {
  //  empty
}
