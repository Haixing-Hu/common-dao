 ...
 * @author 胡海星
 */
public interface BasicHasInfoByCodeByParentNameMapper<T extends HasInfo & Auditable>
    extends BasicByCodeByParentNameMapper<T>, InfoGettableMapper<T>,
    InfoGettableByCodeMapper<T>, InfoGettableByParentNameMapper<T> {
  // empty
}
