...
/**
 * 此接口表示对有备注的实体类实现了更新备注操作的MyBatis Mapper。
 *
 * <p><b>注意：</b>对象的编码必须全局唯一。</p>
 *
 * <p>此接口实现了以下Mapper操作：</p>
 * <ul>
 * <li>{@link #updateCommentByCode(String, String, Instant)}</li>
 * </ul>
 *
 * @param <T>
 ...
 * @author 胡海星
 */
public interface CommentUpdatableByCodeMapper
    <T extends WithCode & WithComment> extends Mapper<T> {
   ...
   *     如果发生其他无法归类的数据库操作错误。
   */
  long updateCommentByCode(@Param("code") String code,
