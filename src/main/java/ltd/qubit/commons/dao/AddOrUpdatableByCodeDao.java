...
import ltd.qubit.commons.dao.mapper.AddOrUpdatableByCodeMapper;
...
import static ltd.qubit.commons.dao.DaoImplHelper.addOrUpdateByCodeImpl;
 ...
 * @author 胡海星
 */
public interface AddOrUpdatableByCodeDao<T extends WithCode>
    extends GettableByCodeDao<T>, AddableDao<T>, UpdatableByCodeDao<T> {

  @Override
  AddOrUpdatableByCodeMapper<T> getMapper();
   ...
   *     若发生任何其他数据存取错误。
   */
  default Instant addOrUpdateByCode(final T obj) throws DataAccessException {
    return addOrUpdateByCodeImpl(this, obj);
  }
