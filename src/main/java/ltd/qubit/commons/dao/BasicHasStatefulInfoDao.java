...
import ltd.qubit.commons.dao.mapper.BasicHasStatefulInfoMapper;
 ...
 * @author 胡海星
 */
public interface BasicHasStatefulInfoDao<T extends HasStatefulInfo & Auditable>
    extends BasicStatefulDao<T>, StatefulInfoGettableDao<T> {

  @Override
  BasicHasStatefulInfoMapper<T> getMapper();
