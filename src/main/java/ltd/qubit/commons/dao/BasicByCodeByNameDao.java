...
import ltd.qubit.commons.dao.mapper.BasicByCodeByNameMapper;
 ...
 * @author 胡海星
 */
public interface BasicByCodeByNameDao
    <T extends Identifiable & WithCode & WithName & Auditable>
    extends BasicByCodeDao<T>, GettableByNameDao<T>, UpdatableByNameDao<T>,
    AddOrUpdatableByNameDao<T>, DeletableByNameDao<T>, ErasableByNameDao<T> {

  @Override
  BasicByCodeByNameMapper<T> getMapper();
