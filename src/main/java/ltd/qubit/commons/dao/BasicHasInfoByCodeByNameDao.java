 ...
 * @author 胡海星
 */
public interface BasicHasInfoByCodeByNameDao<T extends HasInfo & Auditable>
    extends BasicByCodeByNameDao<T>, InfoGettableDao<T>,
    InfoGettableByCodeDao<T>, InfoGettableByNameDao<T>   {

  @Override
  BasicHasInfoByCodeByNameMapper<T> getMapper();
