 ...
 * @author 胡海星
 */
public interface BasicHasInfoWithEntityByCodeByEntityNameDao
    <T extends HasInfoWithEntity & Auditable>
    extends BasicByCodeByEntityNameDao<T>,
    InfoWithEntityGettableDao<T>,
    InfoWithEntityGettableByCodeDao<T>,
    InfoWithEntityGettableByEntityNameDao<T> {

  @Override
  BasicHasInfoWithEntityByCodeByEntityNameMapper<T> getMapper();
