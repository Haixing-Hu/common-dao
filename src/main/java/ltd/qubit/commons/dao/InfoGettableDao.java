...
import ltd.qubit.commons.dao.mapper.InfoGettableMapper;
 ...
 *     被操作的实体的类型。
 */
public interface InfoGettableDao<T extends HasInfo> extends Dao<T> {

  @Override
  InfoGettableMapper<T> getMapper();
   ...
   */
  @NotNull
  default Info getInfo(final Long id) throws DataAccessException {
   ...
   */
  @Nullable
  default Info getInfoOrNull(final Long id) throws DataAccessException {
