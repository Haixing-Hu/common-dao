...
import ltd.qubit.commons.dao.mapper.BasicStatefulByCodeByParentNameMapper;
 ...
 * @author 胡海星
 */
public interface BasicStatefulByCodeByParentNameDao
    <T extends Identifiable & WithName & WithCode & Stateful & Auditable>
    extends BasicStatefulByCodeDao<T>,
    ListableAddOrUpdatableByParentNameDao<T>,
    StateUpdatableByParentNameDao<T>,
    DeletableByParentNameDao<T>,
    ErasableByParentNameDao<T> {

  @Override
  BasicStatefulByCodeByParentNameMapper<T> getMapper();
