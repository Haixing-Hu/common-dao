...
import ltd.qubit.commons.dao.mapper.BasicHasStatefulInfoByCodeByParentNameMapper;
 ...
 * <li>{@link #getInfoByNameOrNull(String, String)}，此函数返回一个{@link StatefulInfo}对象或{@code null}</li>
 ...
 * @author 胡海星
 */
public interface BasicHasStatefulInfoByCodeByParentNameDao
    <T extends HasStatefulInfo & Auditable>
    extends BasicStatefulByCodeByParentNameDao<T>,
    StatefulInfoGettableDao<T>,
    StatefulInfoGettableByCodeDao<T>,
    StatefulInfoGettableByParentNameDao<T> {

  @Override
  BasicHasStatefulInfoByCodeByParentNameMapper<T> getMapper();
}
