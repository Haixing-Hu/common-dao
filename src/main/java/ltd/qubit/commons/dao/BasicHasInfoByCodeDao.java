 ...
 * @author 胡海星
 */
public interface BasicHasInfoByCodeDao<T extends HasInfo & Auditable>
    extends BasicByCodeDao<T>, InfoGettableDao<T>, InfoGettableByCodeDao<T> {

  @Override
  BasicHasInfoByCodeMapper<T> getMapper();
