...
import ltd.qubit.commons.dao.mapper.AddOrUpdatableByNameMapper;
...
import static ltd.qubit.commons.dao.DaoImplHelper.addOrUpdateByNameImpl;
 ...
 * @author 胡海星
 */
public interface AddOrUpdatableByNameDao<T extends WithName>
    extends GettableByNameDao<T>, AddableDao<T>, UpdatableByNameDao<T> {

  @Override
  AddOrUpdatableByNameMapper<T> getMapper();
  ...
  default Instant addOrUpdateByName(final T obj) throws DataAccessException {
    return addOrUpdateByNameImpl(this, obj);
  }
