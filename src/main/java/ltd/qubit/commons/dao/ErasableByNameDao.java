...
import ltd.qubit.commons.dao.mapper.ErasableByNameMapper;
 ...
 * @author 胡海星
 */
public interface ErasableByNameDao<T extends WithName>
    extends Dao<T> {

  @Override
  ErasableByNameMapper<T> getMapper();
   ...
   */
  default void eraseByName(final String name) throws DataAccessException {
    eraseByKeyImpl(this, t -> getMapper().eraseByName(name), "name", name);
  }
}
