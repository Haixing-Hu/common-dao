...
import ltd.qubit.commons.dao.mapper.StatefulInfoGettableByParentCodeMapper;
 ...
 *     被操作的实体的类型。
 */
public interface StatefulInfoGettableByParentCodeDao<T extends HasStatefulInfo>
    extends InfoGettableByParentCodeDao<T> {

  @Override
  StatefulInfoGettableByParentCodeMapper<T> getMapper();
   ...
   */
  @NotNull
  default StatefulInfo getInfoByCode(final String parentCode, final String code)
      throws DataAccessException {
   ...
   */
  @Nullable
  default StatefulInfo getInfoByCodeOrNull(final String parentCode, final String code)
      throws DataAccessException {
