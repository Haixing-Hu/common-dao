...
import ltd.qubit.commons.dao.mapper.BasicHasInfoMapper;
 ...
 * @author 胡海星
 */
public interface BasicHasInfoDao<T extends HasInfo & Auditable>
    extends BasicDao<T>, InfoGettableDao<T> {

  @Override
  BasicHasInfoMapper<T> getMapper();
