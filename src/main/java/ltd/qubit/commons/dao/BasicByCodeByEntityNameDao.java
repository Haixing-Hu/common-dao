...
import ltd.qubit.commons.dao.mapper.BasicByCodeByEntityNameMapper;
 ...
 * @author 胡海星
 */
public interface BasicByCodeByEntityNameDao
    <T extends Identifiable & WithCode & WithEntity & WithName & Auditable>
    extends BasicByCodeDao<T>, GettableByEntityNameDao<T>,
    UpdatableByEntityNameDao<T>, AddOrUpdatableByEntityNameDao<T>,
    DeletableByEntityNameDao<T>, ErasableByEntityNameDao<T> {

  @Override
  BasicByCodeByEntityNameMapper<T> getMapper();
