...
import ltd.qubit.commons.dao.mapper.BasicHasInfoByParentCodeMapper;
 ...
 * @author 胡海星
 */
public interface BasicHasInfoByParentCodeDao<T extends HasInfo & Auditable>
    extends BasicByParentCodeDao<T>, InfoGettableDao<T>, InfoGettableByParentCodeDao<T> {

  @Override
  BasicHasInfoByParentCodeMapper<T> getMapper();
