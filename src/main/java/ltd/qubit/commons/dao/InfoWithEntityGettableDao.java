...
import ltd.qubit.commons.dao.mapper.InfoWithEntityGettableMapper;
 ...
 *     被操作的实体的类型。
 */
public interface InfoWithEntityGettableDao<T extends HasInfoWithEntity>
    extends InfoGettableDao<T> {

  @Override
  InfoWithEntityGettableMapper<T> getMapper();
   ...
   */
  @NotNull
  default InfoWithEntity getInfo(final Long id) throws DataAccessException {
   ...
   */
  @Nullable
  default InfoWithEntity getInfoOrNull(final Long id) throws DataAccessException {
