...
import ltd.qubit.commons.dao.mapper.BasicByParentNameMapper;
 ...
 * @author 胡海星
 */
public interface BasicByParentNameDao<T extends Identifiable & WithName & Deletable>
    extends BasicDao<T>, ListableAddOrUpdatableByParentNameDao<T>,
    DeletableByParentNameDao<T>, ErasableByParentNameDao<T> {

  @Override
  BasicByParentNameMapper<T> getMapper();
