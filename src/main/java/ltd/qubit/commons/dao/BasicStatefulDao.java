...
/**
 * 此接口表示实现了对实体类进行列表、查询、添加、更新、更新状态、标记删除、恢复删除、
 * 彻底删除、清空数据库等操作DAO。
 *
 * <p>此接口实现了以下DAO操作：</p>
 * <ul>
 ...
 * @author 胡海星
 */
public interface BasicStatefulDao<T extends Identifiable & Stateful & Auditable>
    extends BasicDao<T>, StateUpdatableDao<T> {

  @Override
  BasicStatefulMapper<T> getMapper();
