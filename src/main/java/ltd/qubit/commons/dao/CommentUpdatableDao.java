 ...
 * @author 胡海星
 */
public interface CommentUpdatableDao<T extends Identifiable & WithComment>
    extends Dao<T> {

  @Override
  CommentUpdatableMapper<T> getMapper();
  ...
  default Instant updateComment(final Long id, @Nullable final String comment)
      throws DataAccessException {
    return updatePropertyByKeyImpl(this,
        modifyTime -> getMapper().updateComment(id, comment, modifyTime),
