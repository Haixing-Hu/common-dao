 ...
 * @author 胡海星
 */
public interface DeletableByCodeDao<T extends Identifiable & WithCode & Deletable>
    extends Dao<T> {

  @Override
  DeletableByCodeMapper<T> getMapper();
   ...
   *     若发生任何其他数据存取错误。
   * @see #purgeByCode(String)
   * @see #restoreByCode(String)
   */
  @Modified("deleteTime")
  default Instant deleteByCode(final String code) throws DataAccessException {
    return deleteByKeyImpl(this, t -> getMapper().deleteByCode(code, t), "code", code);
  }
   ...
   * @throws DataAccessException
   *     若发生任何其他数据存取错误。
   * @see #deleteByCode(String)
   * @see #purgeByCode(String)
   */
  @Modified("deleteTime")
  default void restoreByCode(final String code) throws DataAccessException {
    restoreByKeyImpl(this, t -> getMapper().restoreByCode(code), "code", code);
  }
   ...
   * @see #restoreByCode(String)
   */
  default void purgeByCode(final String code) throws DataAccessException {
    purgeByKeyImpl(this, t -> getMapper().purgeByCode(code), "code", code);
  }
}
