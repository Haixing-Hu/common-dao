...
import ltd.qubit.commons.dao.mapper.BasicUpdatableMapper;
 ...
 * @author 胡海星
 */
public interface BasicUpdatableDao<T extends Identifiable>
    extends BasicAddableDao<T>, UpdatableDao<T> {

  @Override
  BasicUpdatableMapper<T> getMapper();
