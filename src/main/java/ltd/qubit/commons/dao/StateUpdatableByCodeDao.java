...
import ltd.qubit.commons.dao.mapper.StateUpdatableByCodeMapper;
 ...
 * @author 胡海星
 */
public interface StateUpdatableByCodeDao<T extends WithCode & Stateful>
    extends Dao<T> {

  @Override
  StateUpdatableByCodeMapper<T> getMapper();
  ...
  default Instant updateStateByCode(final String code, final State state)
      throws DataAccessException {
    return updatePropertyByKeyImpl(this,
        modifyTime -> getMapper().updateStateByCode(code, state, modifyTime),
